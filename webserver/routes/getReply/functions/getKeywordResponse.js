...
let QuestionResponse = require('./getQuestionResponse');
let User = require('./../../../models/user');
let client = require('./redis');
let log4js = require('log4js');
let logger = log4js.getLogger();
module.exports = function(keywords, email, types, sendResponse, otherDomainResponse, flag, correctedQuestion, answerFoundCallback, noAnswerFoundCallback) {
        ...
        session.run(query).then(function(result) {
            ...
            if (result.records.length === 0) {
                ...
                if(domain!== differentDomain){
                  ...
                  QuestionResponse(['definition'],keywords, email, types, answerFoundCallback, noAnswerFoundCallback, flag, correctedQuestion);
                }

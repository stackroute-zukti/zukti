...
export default class Pomodoro extends React.Component {
    ...
    setDefaultTime() {
        ...
        this.setState({time: defaultTime, timeType: defaultTime, title: this.getTitle(defaultTime), play: false});
    }
    ...
    render() {
        ...
        return (
            <div className="pomodoro">
                <GithubCorner href="https://github.com/afonsopacifer/react-pomodoro" bannerColor="#2BA0A0" octoColor="#272727"/>
                ...
                <div className="main">
                    ...
                    <div className="container display timer">
                        ...
                        <span className="timeType">The {this.formatType(this.state.timeType)}
                            time!</span>
                    </div>

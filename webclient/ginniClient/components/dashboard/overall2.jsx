...
export default class Overall2 extends React.Component {
    constructor() {
        super()
    ...
    render() {
        ...
        const data = [
            {label: "Total attempted questions", value: slice1, color: "#a23bec"},
            {label: "Guessed answers", value: slice2, color: "#e238ec"}
        ]

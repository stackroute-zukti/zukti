...
export default class AddConcept extends React.Component {
    ...
    createNewConcept(e) {
        ...
        if (newConceptText && existingConcept && relation) {
            ...
            Axios.post(url, {
                ...
                this.setState({opensnackbar: true, snackbarMsg: 'New Concept Added'});
                localStorage.setItem('query', `match (n:concept)-[r]-(m:concept)
                              where n.name='${existingConcept}' return n, r, m`);
                this.setState({
                  graph: <span></span>
                });
                this.setState({
    ...
    render() {
        ...
        <input autoComplete='off' type='text' ref='newConceptText' placeholder='Type Concept Name'/>
                        ...
                        <br/>
                        <Grid.Row>
                <Button color='facebook' fluid onClick={this.createNewConcept}>Add</Button>

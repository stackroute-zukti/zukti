...
export default class rename extends React.Component {
    ...
    getConcept(concept) {
        ...
        localStorage.setItem('query', `match (n:concept)-[r]-(m:concept)
         where n.name='${concept}' return n, r, m`);
    ...
    // ajax call for renaming concept in graph databse
        ...
        Axios.put(url, {
            ...
            if (response.data.saved) {
              ...
              this.setState({opensnackbar: true, snackbarMsg: 'Concept Renamed'});
            }
        ...
        localStorage.setItem('query', `match (n:concept)-[r]-(m:concept)
                    where n.name='${renameConceptText}' return n, r, m`);
        this.setState({
            graph: <div><span></span>
            <frameset>
                  ...
                  <Grid.Column width={1}/>
                    <Grid.Column width={6}>
                      ...
                      <Grid.Row/>
                        ...
                        <br/>
                        <Grid.Row>
          <Button color='facebook' fluid  onClick={this.renameConcepts}>Rename</Button>
                        </Grid.Row>
                    </Grid.Column>
                    <Grid.Column width={8}>

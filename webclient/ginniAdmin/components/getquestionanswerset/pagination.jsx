...
export default class Pagination extends React.Component {
    ...
    componentDidMount() {
        this.state.data[0].map((data, index) => {
            this.state.showData.push(
              <Display key = {index} questions={data.questions} answers={data.answers}/>);
        });
    ...
    handlePageChanged(newPage) {
        ...
        this.state.data[this.state.current].map((data1, index) => {
        this.state.showData.push(<Display key = {index} questions={data1.questions} answers={data1.answers}/>);
        });
        this.setState({showData: this.state.showData});
    }

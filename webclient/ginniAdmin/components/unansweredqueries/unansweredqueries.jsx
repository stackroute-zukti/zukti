...
export default class UnansweredQueries extends React.Component {
  ...
  componentDidMount() {
     ...
     render() {
         var user = this.state.detailNew.map(function(newsdata, index) {
        return (
          <div key={index}>
            <Grid >
                  <Grid.Row>
       ...
       src={require('../../../../webserver/images/defultImage.jpg')}/></Grid.Column>
                          ...
                          <Grid.Column width={5} style={{color: 'green'}}>
                            <Grid.Row/>
                          <h5>Keyword:</h5><h4 style={{color: 'black'}}>{newsdata.keywords}</h4>
                          <h5>Intent:</h5><h4 style={{color: 'black'}}>{newsdata.intents}</h4>
                          <Grid.Row/>
                          </Grid.Column>
                        </Grid>
</Grid.Column>
